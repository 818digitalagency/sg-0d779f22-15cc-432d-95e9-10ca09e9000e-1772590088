...
export default function LoginPage() {
  ...
  return (
    <>
      <SEO title="Sign In - Opportunity Finder" />
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <Link href="/" className="inline-flex items-center gap-3 mb-4">
              ...
              <div className="text-left">
                <div className="text-xl font-bold text-slate-900">Opportunity Finder</div>
                <div className="text-xs text-slate-600">Discover. Engage. Convert.</div>
              </div>
            </Link>
          </div>
          ...
          <Card className="border-slate-200 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Sign in to access your lead intelligence dashboard</CardDescription>
            </CardHeader>
            <CardContent>
